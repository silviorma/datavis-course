...
d3.tsv("https://gist.githubusercontent.com/emanueles/7fbdcd8ee412e3e63904114cf9d7ee3a/raw/af4fd93db1be3f9033caff46d4a574a54bf9363f/unemployment.tsv").then(function (data) {
  ...
  main.variable(observer("countyById")).define("countyById", ["d3"], function(d3){return(
  ...
  main.variable(observer("tooltip")).define("tooltip", ["d3"], function(d3)
{
  ...
  let node = d3.select("body")
               ...
               .attr("class", "hidden")
               .append("p")
               .html("<strong id='nomeCondado'></strong> <br /> Taxa de desemprego: <span id='taxa'></span>")
  
  return node
}
);
  main.variable(observer("showTooltip")).define("showTooltip", ["d3","rateById","countyById"], function(d3,rateById,countyById){return(
